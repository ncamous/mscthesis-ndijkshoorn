...
The accurracy of the elevation map is evaluated in terms of elevation error and the error in the estimated size of objects.
...
After fully traversing the stair, the measured final elevation is $313\begin{small}cm\end{small}$ and the accuracy is $(313/480) \times 100 = 65\%$.
