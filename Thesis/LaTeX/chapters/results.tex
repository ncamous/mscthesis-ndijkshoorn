...
However, the error increases steadily over time due to drift.
...
Therefore, an additional appearance-based method is required to estimate the velocity at all times.
