...
\begin{table}[htb!]
	...
	\hline
    \end{tabular}
    \caption{Simulated AR.Drone (USARSim)}
...
\begin{figure}[htb!]
  \begin{center}
    \subfigure[A]{\label{fig:exp3-a}%
	\includegraphics[width=1.0\linewidth]{images/exp3-ar-res-error.eps}}%
\\
    \subfigure[B]{\label{fig:exp3-b}%
\includegraphics[width=1.0\linewidth]{images/exp3-usar-res-error.eps}}
