...
\advance\leftskip-2.5cm\rightskip-2.5cm
    \subfigure[Blup]{\label{visual-slam-elevation-map1}\includegraphics[width=0.4\linewidth]{images/elevation_map1.png}}
    %\hspace{1cm}
    \subfigure[Blup]{\label{visual-slam-elevation-map2}\includegraphics[width=0.4\linewidth]{images/elevation_map2.png}}
    \subfigure[Blup]{\label{visual-slam-elevation-map3}\includegraphics[width=0.4\linewidth]{images/elevation_map3.png}}
 \end{center}
  \caption{Blup.}
